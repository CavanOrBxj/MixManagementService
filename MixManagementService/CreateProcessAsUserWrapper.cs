...
namespace MixManagementService
{
    ...
    {
        public static void LaunchChildProcess(string ChildProcName,string arg, ref PROCESS_INFORMATION tProcessInfo, ref bool ChildProcStarted)
        {
                        ...
                        if (WTSQueryUserToken(tSessionInfo.SessionID, out hToken))
                        {
                          ...
                          //  PROCESS_INFORMATION tProcessInfo;
                            ...
                            tStartUpInfo.cb = Marshal.SizeOf(typeof(STARTUPINFO));
                             ...
                             ChildProcStarted = CreateProcessAsUser(
                                hToken,             // Token of the logged-on user.
                                ChildProcName,      // Name of the process to be started.
                               " " + arg,// null,               // Any command line arguments to be passed.
                                IntPtr.Zero,        // Default Process' attributes.
                                IntPtr.Zero,        // Default Thread's attributes.
                                false,              // Does NOT inherit parent's handles.
                                0,                  // No any specific creation flag.
                                null,               // Default environment path.
                              Path.GetDirectoryName(ChildProcName),//  null,               // Default current directory.
