    ...
    public class DataGridViewStateCell : DataGridViewButtonCell
    {
        ...
        public LightState PowerState
        {
            ...
            set
            {
                ...
                {
                    powerState = value;
                    if(value == LightState.Bad)
                    {
                        powerState = LightState.On;
                    }
                }
                switch (powerState)
                {
            ...
            DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (value == null && (formattedValue == null || string.IsNullOrWhiteSpace(formattedValue.ToString())))
            {
                PowerState = LightState.Off;
            }
            else
            {
                PowerState = value == null ? (LightState)int.Parse(formattedValue.ToString()) : (LightState)value;
            }
